...
barcode_faker <- function(fastq_dir, read_length = 150L){
...
barcode_faker(fastq_dir = "/media/HDD/wittney2/Simulated_sequence_reads/rad_reads/new_fastq_files_5", read_length = 150)
